			...
			<div class="card-body">
				<form id="manage-attendance">
					...
					<div class="row justify-content-center">
						...
						<button onclick="openFaceRecognition()" type="button" id="face_recognition_button" style="height: auto; padding: 10px; font-size: 16px; width: auto; outline: black; border:  1px solid black; background: #007bff73; color: black; display: none;"><img src="assets/uploads/ic_face_recognition.png" style="height: 20px; width:20px; color: black;"> Start face recogniton</button>
					</div>
...
$(document).ready(function(){
	...
	function openFaceRecognition(){
		...
		//alert($('#class_subject_id').val());
		alert_toast("Face recognition triggered...");
		start_load()
		
		$.ajax({
			url:'../../apis/trigger-camera.php',
			data: {attendance_id:$('#class_subject_id').val(),date_selected:date_selected},
			method:'POST',
			success:function(resp){
				alert_toast(resp);
				end_load();
